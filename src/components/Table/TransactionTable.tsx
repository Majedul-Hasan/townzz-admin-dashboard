...
const TransactionTable = () => {
  const { data: paymentTable, isLoading } =
  ...
  const totalPages = paymentTable && paymentTable?.data?.meta.totalPage;

  const currentPageData =
    paymentTable?.data?.data && paymentTable?.data?.data?.SUBSCRIPTION;
